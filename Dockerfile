...
RUN mkdir -p $GOPATH/src/github.com/ggpeti/postgrest-auth
WORKDIR $GOPATH/src/github.com/ggpeti/postgrest-auth
...
COPY --from=builder /go/src/github.com/ggpeti/postgrest-auth/postgrest-auth .
